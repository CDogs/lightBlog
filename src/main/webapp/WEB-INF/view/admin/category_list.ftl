    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="${rc.contextPath}/admin/category/add.htm" method="post" id="myform">
                    <table class="search-tab">
                        <tr>
                            <th width="70">类别添加:</th>
                            <td><input class="common-text" placeholder="类别名" name="name" value="" id="" type="text"></td>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                ...
                <#else>
                    <tr align="center" clospan="4">还没有类别</tr>
                </#if>
                </table>
